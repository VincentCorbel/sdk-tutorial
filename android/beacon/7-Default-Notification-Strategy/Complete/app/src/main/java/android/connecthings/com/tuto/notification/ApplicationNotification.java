...
import android.connecthings.util.adtag.beacon.strategy.Notification.BeaconNotificationStrategySpamMaxFilter;
import android.connecthings.util.adtag.beacon.strategy.Notification.BeaconNotificationStrategySpamRegionFilter;
import android.connecthings.util.adtag.beacon.strategy.Notification.BeaconNotificationStrategySpamTimeFilter;
